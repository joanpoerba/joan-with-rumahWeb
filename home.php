...
<head>
  ...
  <link rel="preload" as="image" href="assets/hero1.avif">
...
<body>
  ...
  <div class="wrapper container-fluid">
        ...
        <nav class="w-50 mt-xxl-0 mt-xl-0 mt-lg-0 mt-md-3 mt-sm-3">
          <ul class="d-flex flex-xxl-row flex-xl-row flex-lg-row flex-md-column flex-sm-column justify-content-evenly align-items-xxl-center align-items-xl-center align-items-lg-center align-items-md-start align-items-sm-start">
            <li class="list-unstyled d-xxl-block d-xl-block d-lg-block d-md-flex d-sm-flex flex-row justify-content-center align-items-center fs-6 mx-xxl-0 mx-xl-0 mx-lg-0 mx-md-4 mx-sm-4">
              ...
              <a class="text-decoration-none ms-xxl-0 ms-xl-0 ms-lg-0 ms-md-3 ms-sm-3 border-2 border-bottom" href="home.php">Home</a>
            </li>
            ...
            <li class="list-unstyled d-xxl-block d-xl-block d-lg-block d-md-flex d-sm-flex flex-row justify-content-center align-items-center fs-6 ms-xxl-5 ms-xl-5 ms-lg-5 ms-md-4 ms-sm-4 my-xxl-0 my-xl-0 my-lg-0 my-md-3 my-sm-3">
              ...
              <a class="text-decoration-none ms-xxl-0 ms-xl-0 ms-lg-0 ms-md-3 ms-sm-3" href="view/rumahWeb.php">RumahWeb</a>
            </li>
          </ul>
        </nav>
    ...
    <main class="row container-fluid my-xxl-0 my-xl-9 my-lg-0 my-md-5 my-sm-5">
      <section class="col-xxl-7 col-xl-7 col-lg-7 d-flex justify-content-center align-items-center">
        <div class="d-flex flex-column justify-content-center align-items-xxl-start align-items-xl-start align-items-lg-start align-items-md-center align-items-sm-center">
          <div class="d-flex flex-row justify-content-center align-items-center">
            <h1 class="fw-bold">Hi! I'm</h1>
            <div class="preBackEndDevWrapper rounded-pill py-2 px-4 ms-3">
              <h3 class="fw-semibold text-light">Pre Back-end Dev</h3>
            </div>
          </div>
          <div class="mt-3">
            <h1 class="fw-bold">Joan Orlando Purba</h1>
          </div>
          <div class="mt-4 text-xxl-start text-xl-start text-lg-start text-md-center text-sm-center">
            <h5 class="fw-normal">Designing for <span class="fw-semibold">website</span> and <span class="fw-semibold">UI</span> for over 2 years <br> as a <span class="fw-semibold">coder</span> and <span class="fw-semibold">UI/UX designer</span></h5>
          </div>
          <div class="mt-4">
            <button class="py-2 px-xxl-3 px-xl-3 px-lg-3 px-md-5 px-sm-5 fw-semibold rounded-2 border-0 text-light">All Portfolio</button>
          </div>
          <div class="d-flex justify-content-center align-items-center mt-3">
            <div>
              <h5>+10</h5>
              <h6 class="fw-normal">Clients in real live</h6>
            </div>
            <div class="ms-5">
              <h5>+13</h5>
              <h6 class="fw-normal">Projects done</h6>
            </div>
          </div>
        </div>
      </section>
      <section class="col-xxl-5 col-xl-5 col-lg-5 d-xxl-flex d-xl-flex d-lg-flex d-md-flex d-sm-flex justify-content-center align-items-center py-xxl-0 py-xl-0 py-lg-0 py-md-5 py-sm-5">
        <div class="heroWrapper d-flex justify-content-center align-items-end h-100">
          <img class="" src="assets/hero1.avif" alt="">
        </div>
      </section>
    </main>
  </div>
